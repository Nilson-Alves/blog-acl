...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">ACL Laravel</h2>
    </div>
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="{{route('login')}}" method="POST">
        ...
        <div>
          <div class="flex items-center justify-between">
            ...
            <div class="text-sm">
              <a href="{{route('logout')}}" class="font-semibold text-indigo-600 hover:text-indigo-500">Esqueceu a senha?</a>
            </div>
          </div>
          <div class="mt-2">
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        ACL Laravel
        <a href="#" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500"> Webmentor</a>
      </p>
    </div>
  </div>
@endsection
